...
object MyPlayerAI : StateListener {
    override fun onBroadcast(playerId: UUID, levelStateBroadcast: LevelStateBroadcast, client: RequestClient) {
        if (levelStateBroadcast.ticksUntilBegin > 0) {
            return // do nothing when game has not yet started
        }
...
fun main(args: Array<String>) {
    ClientFramework("localhost", EnigmaShowdownConstants.PORT_SERVER, MyPlayerAI).start()
}
